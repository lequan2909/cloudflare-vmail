...
The API allows you to programmatically create temporary mailboxes,
  ...
  <div class="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
    <div class="flex items-start gap-3">
      ...
      <div class="text-sm text-blue-800 dark:text-blue-300">
        <strong>Base URL:</strong> <code class="bg-blue-100 dark:bg-blue-900/50 px-2 py-0.5 rounded">/api/v1</code>
      </div>
    </div>
  </div>
</div>
